...
// Form options
$options['captcha_secret']      = 'YOUR_SITE_SECRET_KEY';                     // Google reCAPTCHA secret key
...
$options['from_address']        = 'leonedsgn@gmail.com';               // Address the email is sent from
$options['from_name']           = 'Leone Design';                              // Name to attach to the address
$options['to_addresses']        = array( 'leonedsgn@gmail.com' );               // To: addresse(s), add new array item for more
$options['bcc_addresses']       = array( 'leonedsgn@gmail.com' );               // BCC: addresse(s), add new array item for more
